...
@BennuSpringModule(basePackages = "com.qubit.solution.fenixedu.integration.ldap", bundles = "LdapintegrationResources")
public class BennuLdapIntegrationSpringConfiguration {
}
